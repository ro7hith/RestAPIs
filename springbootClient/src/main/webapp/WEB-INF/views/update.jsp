...
<m:Master title="Insert Employee">
	...
	function fetch()
	{
		var e=document.getElementsByName("empno")[0].value;
		window.location.href="fetchByEmpId?empno="+e;
	}
	...
	<f:form modelAttribute="employee">
	<table class="table table-bordered">
	<tr>
					<td class="tdcol">Employee No</td>
					<td class="tdcol"><f:input path="empno" onblur="fetch();" /></td>
	...
	<tr>
					<td><input type="submit" value="Update" formaction="UpdateEmp"></td>
					<td><input type="submit" value="Delete" formaction="DeleteEmp"></td>
